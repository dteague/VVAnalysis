...
float getTruePUw_Moriond(int nvtx) {
    ...
    else if (nvtx>=1.000000 && nvtx<2.000000) return 0.868822;
    else if (nvtx>=2.000000 && nvtx<3.000000) return 1.060915;
    else if (nvtx>=3.000000 && nvtx<4.000000) return 0.804616;
    else if (nvtx>=4.000000 && nvtx<5.000000) return 1.279666;
    else if (nvtx>=5.000000 && nvtx<6.000000) return 1.377812;
    else if (nvtx>=6.000000 && nvtx<7.000000) return 0.704106;
    else if (nvtx>=7.000000 && nvtx<8.000000) return 0.494254;
    else if (nvtx>=8.000000 && nvtx<9.000000) return 0.718032;
    else if (nvtx>=9.000000 && nvtx<10.000000) return 0.853469;
    else if (nvtx>=10.000000 && nvtx<11.000000) return 0.938278;
    else if (nvtx>=11.000000 && nvtx<12.000000) return 1.057068;
    else if (nvtx>=12.000000 && nvtx<13.000000) return 1.122293;
    else if (nvtx>=13.000000 && nvtx<14.000000) return 1.153207;
    else if (nvtx>=14.000000 && nvtx<15.000000) return 1.205728;
    else if (nvtx>=15.000000 && nvtx<16.000000) return 1.198719;
    else if (nvtx>=16.000000 && nvtx<17.000000) return 1.184970;
    else if (nvtx>=17.000000 && nvtx<18.000000) return 1.176247;
    else if (nvtx>=18.000000 && nvtx<19.000000) return 1.127847;
    else if (nvtx>=19.000000 && nvtx<20.000000) return 1.083409;
    else if (nvtx>=20.000000 && nvtx<21.000000) return 1.063132;
    else if (nvtx>=21.000000 && nvtx<22.000000) return 1.042620;
    else if (nvtx>=22.000000 && nvtx<23.000000) return 1.045930;
    else if (nvtx>=23.000000 && nvtx<24.000000) return 1.047821;
    else if (nvtx>=24.000000 && nvtx<25.000000) return 1.042626;
    else if (nvtx>=25.000000 && nvtx<26.000000) return 1.056079;
    else if (nvtx>=26.000000 && nvtx<27.000000) return 1.068642;
    else if (nvtx>=27.000000 && nvtx<28.000000) return 1.077145;
    else if (nvtx>=28.000000 && nvtx<29.000000) return 1.090889;
    else if (nvtx>=29.000000 && nvtx<30.000000) return 1.102057;
    else if (nvtx>=30.000000 && nvtx<31.000000) return 1.089665;
    else if (nvtx>=31.000000 && nvtx<32.000000) return 1.066530;
    else if (nvtx>=32.000000 && nvtx<33.000000) return 1.037292;
    else if (nvtx>=33.000000 && nvtx<34.000000) return 0.969761;
    else if (nvtx>=34.000000 && nvtx<35.000000) return 0.900420;
    else if (nvtx>=35.000000 && nvtx<36.000000) return 0.814996;
    else if (nvtx>=36.000000 && nvtx<37.000000) return 0.701494;
    else if (nvtx>=37.000000 && nvtx<38.000000) return 0.601403;
    else if (nvtx>=38.000000 && nvtx<39.000000) return 0.492305;
    else if (nvtx>=39.000000 && nvtx<40.000000) return 0.400363;
    else if (nvtx>=40.000000 && nvtx<41.000000) return 0.308498;
    else if (nvtx>=41.000000 && nvtx<42.000000) return 0.225170;
    else if (nvtx>=42.000000 && nvtx<43.000000) return 0.162180;
    else if (nvtx>=43.000000 && nvtx<44.000000) return 0.111863;
    else if (nvtx>=44.000000 && nvtx<45.000000) return 0.077390;
    else if (nvtx>=45.000000 && nvtx<46.000000) return 0.050697;
    else if (nvtx>=46.000000 && nvtx<47.000000) return 0.031394;
    else if (nvtx>=47.000000 && nvtx<48.000000) return 0.020052;
    else if (nvtx>=48.000000 && nvtx<49.000000) return 0.012629;
    else if (nvtx>=49.000000 && nvtx<50.000000) return 0.007430;
    else if (nvtx>=50.000000 && nvtx<51.000000) return 0.004380;
    else if (nvtx>=51.000000 && nvtx<52.000000) return 0.002608;
    else if (nvtx>=52.000000 && nvtx<53.000000) return 0.001566;
    else if (nvtx>=53.000000 && nvtx<54.000000) return 0.000971;
    else if (nvtx>=54.000000 && nvtx<55.000000) return 0.000729;
    else if (nvtx>=55.000000 && nvtx<56.000000) return 0.000673;
    else if (nvtx>=56.000000 && nvtx<57.000000) return 0.000730;
    else if (nvtx>=57.000000 && nvtx<58.000000) return 0.000949;
    else if (nvtx>=58.000000 && nvtx<59.000000) return 0.001355;
    else if (nvtx>=59.000000 && nvtx<60.000000) return 0.001894;
    else if (nvtx>=60.000000 && nvtx<61.000000) return 0.003082;
    else if (nvtx>=61.000000 && nvtx<62.000000) return 0.004097;
    else if (nvtx>=62.000000 && nvtx<63.000000) return 0.004874;
    else if (nvtx>=63.000000 && nvtx<64.000000) return 0.005256;
    else if (nvtx>=64.000000 && nvtx<65.000000) return 0.005785;
    else if (nvtx>=65.000000 && nvtx<66.000000) return 0.005515;
    else if (nvtx>=66.000000 && nvtx<67.000000) return 0.005000;
    else if (nvtx>=67.000000 && nvtx<68.000000) return 0.004410;
    else if (nvtx>=68.000000 && nvtx<69.000000) return 0.004012;
    else if (nvtx>=69.000000 && nvtx<70.000000) return 0.003548;
    else if (nvtx>=70.000000 && nvtx<71.000000) return 0.003108;
    else if (nvtx>=71.000000 && nvtx<72.000000) return 0.002702;
    else if (nvtx>=72.000000 && nvtx<73.000000) return 0.002337;
    else if (nvtx>=73.000000 && nvtx<74.000000) return 0.002025;
    else if (nvtx>=74.000000 && nvtx<75.000000) return 0.001723;
